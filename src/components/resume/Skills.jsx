  ...
  return (
    ...
    >
      <div className="w-1/2">
        ...
        <div className="w-full mt-14 h-full flex flex-col gap-6">
          <div className="overflow-x-hidden">
            ...
            <span className="w-full h-2 bgOpacity inline-flex rounded-md mt-2">
              <motion.span
                ...
                className="w-[95%] h-full bg-gradient-to-r from-blue-600 via-pink-400 to-red-500 rounded-md relative"
              >
          ...
          <div className="overflow-x-hidden">
            ...
            <span className="w-full h-2 bgOpacity inline-flex rounded-md mt-2">
              <motion.span
                ...
                animate={{ x: 0, opacity: 1 }}
                transition={{ duration: 0.5, delay: 0.5 }}
                className="w-[75%] h-full bg-gradient-to-r from-blue-600 via-pink-400 to-red-500 rounded-md relative"
              >
          ...
          <div className="overflow-x-hidden">
            ...
            <span className="w-full h-2 bgOpacity inline-flex rounded-md mt-2">
              <motion.span
                ...
                animate={{ x: 0, opacity: 1 }}
                transition={{ duration: 0.5, delay: 0.5 }}
                className="w-[45%] h-full bg-gradient-to-r from-blue-600 via-pink-400 to-red-500 rounded-md relative"
              >
          ...
          <div className="overflow-x-hidden">
            ...
            <span className="w-full h-2 bgOpacity inline-flex rounded-md mt-2">
              <motion.span
                ...
                animate={{ x: 0, opacity: 1 }}
                transition={{ duration: 0.5, delay: 0.5 }}
                className="w-[65%] h-full bg-gradient-to-r from-blue-600 via-pink-400 to-red-500 rounded-md relative"
              >
          ...
          <div className="overflow-x-hidden">
            ...
            <span className="w-full h-2 bgOpacity inline-flex rounded-md mt-2">
              <motion.span
                ...
                animate={{ x: 0, opacity: 1 }}
                transition={{ duration: 0.5, delay: 0.5 }}
                className="w-[65%] h-full bg-gradient-to-r from-blue-600 via-pink-500 to-red-500
              rounded-md relative"
              >
                <span className="absolute -top-7 right-0">65%</span>
              </motion.span>
          ...
          <div className="overflow-x-hidden">
            ...
            <span className="w-full h-2 bgOpacity inline-flex rounded-md mt-2">
              <motion.span
                ...
                animate={{ x: 0, opacity: 1 }}
                transition={{ duration: 0.5, delay: 0.5 }}
                className="w-[60%] h-full bg-gradient-to-r from-blue-600 via-pink-500 to-red-500
              rounded-md relative"
              >
